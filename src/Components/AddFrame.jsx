...
//     axios.post('http://localhost:8080/carts', newCart)
//       .then(response => {
...
//             />
//           ))}
//           <button type="button" onClick={this.handleAddImageDetail}>Add Image Detail</button>
//           <br />
...
//     axios.post("http://localhost:8080/carts/postframe", newCart)
//       .then(response => {
//         if (response.status === 201) {
//           console.log('Cart added successfully');
//         } else {
...
class AddFrame extends Component {
  constructor(props) {
    ...
    this.state = {
      ...
      ratings: '',
      bestSeller: false,
      imageDetails: [''], // Initialize with an empty string for imageDetails
    };
  }
  ...
  handleFormSubmit = async (e) => {
    ...
    // Assuming 'http://localhost:8080/carts/postframe' is the correct API endpoint
    try {
      const response = await axios.post("http://localhost:8080/carts/postframe", newCart);
      if (response.status === 201) {
        console.log('Cart added successfully');
      } else {
        console.error('Error adding cart');
